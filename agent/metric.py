...
class NetworkSpeedMonitor:
    ...
    def get_speed(self):
        ...
        upload_speed = (current_bytes_sent - self.prev_bytes_sent) / time_elapsed / (1024 * 1024)  # MB/s
        download_speed = (current_bytes_recv - self.prev_bytes_recv) / time_elapsed / (1024 * 1024)  # MB/s
